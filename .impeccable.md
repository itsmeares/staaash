...
- Base background: `oklch(13% 0.010 250)` — deep charcoal, faintest steel cast, not pure black
- Surface (panels, cards): `oklch(17% 0.010 250)`
- Elevated surface (popovers, modals): `oklch(21% 0.010 250)`
- Muted text: `oklch(55% 0.010 250)`
- Body text: `oklch(93% 0.008 250)` — off-white, not clinical
- Accent: muted teal `oklch(72% 0.11 195)` — calm, patina quality, not electric
- Accent hover: `oklch(78% 0.11 195)`
- Destructive: `oklch(62% 0.16 25)` — dusty red

**Light palette (OKLCH):**

- Base background: `oklch(97% 0.005 250)`
- Surface: `oklch(100% 0.003 250)`
- Muted text: `oklch(50% 0.010 250)`
- Body text: `oklch(16% 0.012 250)`
- Accent: `oklch(52% 0.13 195)` — teal, readable on light
...
5. **Accessibility is architecture.** WCAG 2.2 AA minimum. Visible focus rings (2px, teal accent offset), full keyboard navigation, reduced-motion support, readable at 200% zoom. Not a compliance checkbox — it is how the product behaves for everyone.

### Two UI Zones

**Workspace** (regular users): calm, personal. Dark surfaces, teal accent, lots of breathing room. Sidebar navigation.

**Admin** (owner): slightly distinct — a warmer or more authoritative tone to signal elevated context. Currently styled with amber/warm tones; maintain that separation but unify typographic style.
